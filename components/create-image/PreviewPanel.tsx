...
import { PREVIEW_RASTER_IMAGE_SIZES } from "./preview-raster-display";
...
type PreviewPanelProps = {
  ...
  /**
   * CSS `filter` applied to preview raster media only (non-destructive; e.g. Image Editor Enhance).
   * Overlays (masks, text) are not affected.
   */
