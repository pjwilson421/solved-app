...
/**
 * URL for full-screen / lightbox preview: highest fidelity, never prefers
 * persisted thumbnail when another URL on the entry is available.
 */
export function bestFullscreenImageUrlForEntry(entry: {
  fullResolutionUrl?: string;
  imageUrls?: string[];
  imageUrl?: string;
  previewUrl?: string;
